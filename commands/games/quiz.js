...
module.exports = class Quiz extends Command {
    ...
    async run(message) {
        ...
        message.channel.send("**Vous avez 30 secondes pour répondre à chaque question!**");
        ...
        function play() {
            ...
            allCollector.on('collect', m => {
                   ...
                   if (playerArray.find(obj => obj.username == m.author.username) == undefined) {
            ...
            message.channel.send(item.question).then(() => {
                ...
                .then(collected => {
                    ...
                    let roundWinner = playerArray.find(obj => obj.username == collected.first().author.username);
