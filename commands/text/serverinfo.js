...
module.exports = class ServerInfo extends (
  ...
  async run(message) {
      ...
      message.say(
        "En parlant de serveur, moi au restaurant je prends toujours une grosse poutine québécoise. C'est tellement bon."
      );
      ...
      message.say(
        `Son dictateur est: **${message.guild.owner.user.username}** (Mais moi je préférerais avoir un premier ministre parce que ça démontre plus ton leadership).`
      );
      message.say(
